...
@section('showcase')
  <section style="max-width:1152px; margin:0 auto; ">
    <h3 style="padding-left:30px; color:rgb(27, 188, 155); font-weight: bolder;" >APARTMANTS</h3>
    <div id="apartmants">
      @if(Auth::user())

      <a style="margin-bottom: 50px;padding-left:30px; color:rgb(27, 188, 155); font-weight: bolder;" href="{{ url('photos/apartmants/add')}}"><button class="btn btn-success uploadBtn">UPLOAD</button><a>
      @endif
      <div class="row">
